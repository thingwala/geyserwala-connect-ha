...
####################################################################################
"""Geyserwala Connect sensor platform."""
...
SENSORS = [
    Sensor("Water Temperature", "tank_temp", None, "mdi:water-thermometer", True),
    Sensor("Collector Temperature", "collector_temp", None, "mdi:sun-thermometer", False),
    Sensor("Element Seconds", "element_seconds", None, "mdi:counter", False),
]
...
async def async_setup_entry(
    ...
    """Set up Geyserwala Connect sensor entities."""
...
class GeyserwalaSensor(GeyserwalaEntity, SensorEntity):
    """Geyserwala Connect sensor entity."""
