...
####################################################################################
"""Geyserwala Connect switch platform."""
...
SWITCHES = [
    ...
    Switch("Low Power Enable", "lowpower_enable", None, "mdi:leaf-off", "mdi:leaf", False),
]
...
async def async_setup_entry(
    ...
    """Set up Geyserwala Connect switch entities."""
...
class GeyserwalaSwitch(GeyserwalaEntity, SwitchEntity):
    """Geyserwala Connect switch entity."""
