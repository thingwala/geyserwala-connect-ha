...
####################################################################################
"""Geyserwala Connect binary sensor platform."""
...
BINARY_SENSORS = [
    BinarySensor("Pump", "pump_status", None, BinarySensorDeviceClass.RUNNING, "mdi:pump", "mdi:pump-off", True),
...
async def async_setup_entry(
    ...
    """Set up Geyserwala Connect binary sensor entities."""
...
class GeyserwalaBinarySensor(GeyserwalaEntity, BinarySensorEntity):
    """Geyserwala Connect binary sensor entity."""
