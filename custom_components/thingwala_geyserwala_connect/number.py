...
####################################################################################
"""Geyserwala Connect number platform."""
...
SENSORS = [
    ...
    Number("External Setpoint", "external_setpoint", None, "mdi:thermostat-cog", False, GEYSERWALA_SETPOINT_TEMP_MIN, GEYSERWALA_SETPOINT_TEMP_MAX),
]
...
async def async_setup_entry(
    ...
    """Set up Geyserwala Connect number entities."""
...
class GeyserwalaNumber(GeyserwalaEntity, NumberEntity):
    """Geyserwala Connect number entity."""
